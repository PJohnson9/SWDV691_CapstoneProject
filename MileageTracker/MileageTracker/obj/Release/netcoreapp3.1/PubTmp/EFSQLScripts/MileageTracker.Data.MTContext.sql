...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20200822030425_UserGUIDs')
BEGIN
    ALTER TABLE [Vehicles] ADD [UserGUID] nvarchar(max) NULL;
END;
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20200822030425_UserGUIDs')
BEGIN
    ALTER TABLE [Projects] ADD [UserGUID] nvarchar(max) NULL;
END;
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20200822030425_UserGUIDs')
BEGIN
    ALTER TABLE [Expenses] ADD [UserGUID] nvarchar(max) NULL;
END;
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20200822030425_UserGUIDs')
BEGIN
    ALTER TABLE [Clients] ADD [UserGUID] nvarchar(max) NULL;
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20200822030425_UserGUIDs', N'3.1.7');
END;
